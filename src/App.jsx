     ...
     <div className="w-full h-screen duration-200" style={{backgroundColor: color}}>
        <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
            <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-full'>
              ...
              <button className='outline-none px-4 py-1 rounded-full text-white shadow-lg'onClick={()=>setColor("tan")} style={{backgroundColor:"tan"}}>Tan</button>
              ...
              <button className='outline-none px-4 py-1 rounded-full text-white shadow-lg'onClick={()=>setColor("lightgray")} style={{backgroundColor:"lightgray"}}>Light Gray</button>
              ...
              <button className='outline-none px-4 py-1 rounded-full text-white shadow-lg'onClick={()=>setColor("skyblue")} style={{backgroundColor:"skyblue"}}>Sky Blue</button>
